...
# Your code here
files_list <- list.files("C:/Users/jonwuo/OneDrive - Karolinska Institutet/Dokument/Forskning/Kurser/Inermediate R/Task day_6", pattern = "*.csv$", full.names = TRUE, recursive = T)
files_list
